    ...
    <nav>
      ...
      >
        <div className="main-nav">
          <div className={`hamburger ${!showSubNav ? 'show' : ''}`} onClick={toggleHamburger} aria-label="Toggle Menu">
            <span></span>
            <span></span>
            <span></span>
          </div>
          ...
          <div className="search-bar">
            ...
            <input type="text" placeholder="What are you looking for?" aria-label="Search input" />
          </div>
        ...
        <div className={`sub-nav ${isHamburgerOpen ? 'active' : ''}`}>
          ...
          <div className="sub-nav-menu">
            ...
            <ul>
              ...
              <li><Link href="/" onClick={handleLinkClick}>LC</Link></li>
              <li><Link href="/" onClick={handleLinkClick}>GC</Link></li>
              <li><Link href="/" onClick={handleLinkClick}>INSTRUMENTATION</Link></li>
              <li><Link href="/" onClick={handleLinkClick}>SYRINGERS</Link></li>
              <li><Link href="/" onClick={handleLinkClick}>SAMPLE PREPARATIONS</Link></li>
              <li><Link href="/" onClick={handleLinkClick}>SUPPORT</Link></li>
            </ul>
          </div>
        </div>
      )}
